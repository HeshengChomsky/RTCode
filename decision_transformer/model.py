...
class MaskedCausalAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        self.last_att_weights = normalized_weights
...
class DecisionTransformer(nn.Module):
    ...
    def forward(self, timesteps, states, actions, returns_to_go, rewards):
        ...
        self.last_att_weights = self.transformer[-1].attention.last_att_weights
        self.att_num_inputs = 4
...
class RTDecisionTransformer(
    ...
    def forward(
        ...
        h = self.transformer(h)
        self.last_att_weights = self.transformer[-1].attention.last_att_weights
        self.att_num_inputs = self.num_inputs
